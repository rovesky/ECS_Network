...
public unsafe class NetworkServer
{
    ...
    {
        serverInfo.serverTickRate = serverTickRate.IntValue;
...
#pragma warning restore
    ...
    void OnConnect(int connectionId, INetworkCallbacks loop)
    {
        ...
        if (m_Connections.Count >= serverMaxClients.IntValue)
        {
...
#pragma warning restore
    ...
    public class ServerConnection : NetworkConnection<NetworkServer.Counters, ServerPackageInfo>
    {
        ...
        public new void Reset()
        {
           ...
           // snapshotSeqs.Clear();
           // snapshotAcks.Clear();
            Array.Clear(snapshotSeqs, 0, snapshotSeqs.Length);
            Array.Clear(snapshotAcks, 0, snapshotAcks.Length);
