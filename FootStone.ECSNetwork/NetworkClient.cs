...
public class NetworkClient
{
    ...
    public long timeSinceSnapshot { get { return m_Connection != null ? NetworkUtils.stopwatch.ElapsedMilliseconds - m_Connection.snapshotReceivedTime : -1; } }
    //public long timeSinceSnapshot { get { return m_Connection != null ? m_Connection.snapshotReceivedTime : -1; } }
    ...
    internal void UpdateClientConfig()
    {
        ...
        clientConfig.serverUpdateRate = clientUpdateRate.IntValue;
        clientConfig.serverUpdateInterval = clientUpdateInterval.IntValue;
